...
const Header : FC<HeaderProps>= (props) : ReactElement => {
    ...
    const headers : number[] = [1,2,3,4,5,6,7,8];

    return (
        <div className='header' >
            <img src="https://www.bellespa.pl/wp-content/themes/bellespa/images/belle-spa-clinic.png" />
            {
                windowSize < 950 && (
                    <>
                        ...
                        {
                            hambOpen ? (
                                <div className='hamb' onClick={() => setHambOpen(!hambOpen)}  >
            ...
            <div className={['Nav ', hambOpen ? "hamb-open" : "hamb-close"].join("  ")} >
                <div className='links' >
                    {headers.map((item : number) => {
                        return (
                            <a href='#' >
                            Link {item} 
                            </a>
